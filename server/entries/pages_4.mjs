...
function _createMdxContent(props) {
  ...
  return jsxs(Fragment, {
    children: [jsx(_components.h1, {
      ...
      children: ["\n", jsx(_components.li, {
        children: "Core => flexible & robust foundation"
      }), "\n", jsx(_components.li, {
        children: "Extensions => quick start, ejectable"
      }), "\n"]
    }), "\n", jsx(_components.p, {
      children: "Sturdy architecture, for you, as well as for us."
    })]
  });
}
...
const configValuesSerialized = {
  ...
  ["Page"]: {
    type: "standard",
    definedAtData: { "filePathToShowToUser": "/pages/4/+Page.mdx", "fileExportPathToShowToUser": [] },
    valueSerialized: {
      type: "plus-file",
